...
#define CONFIG_BOARD_INVERTER_SWITCH_GPIO    GPIO_NUM_6
#define CONFIG_BOARD_AZ1_BUTTON_GPIO    GPIO_NUM_7
#define CONFIG_BOARD_BUTTON_CHARGE_REQUEST_GPIO GPIO_NUM_0
